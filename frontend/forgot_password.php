...
// Create connections
$usersConn = create_db_connection(get_database_name('users'));
$adminsConn = create_db_connection(get_database_name('admins'));
    ...
    if (empty($email)) {
        ...
        if ($result->num_rows === 0) {
            ...
            if (!isset($otp)) {
                ...
                // Send OTP via email
                $headers = "From: vaibjais123456@gmail.com\r\n";
                $headers .= "Reply-To: vaibjais123456@gmail.com\r\n";
                ...
                // Try to send email
                $mailSent = mail($email, "Password Reset OTP - KhojBazaar", $message, $headers);
    ...
    <div class="main-container">
        <div class="background-image">
            <video autoplay muted loop playsinline class="w-full h-full object-cover opacity-90">
                <source src="../photo/login.mp4" type="video/mp4">
            </video>
        </div>
