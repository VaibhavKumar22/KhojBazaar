            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="feature-card p-6 rounded-lg">
                        <div class="text-white text-4xl mb-4">ðŸ”</div>
                        ...
                        From Restaurants , groceries ,toolkits , sports to fashion â€” explore, save, and support nearby businesses effortlessly.</p>
                    </div>
                    <div class="feature-card p-6 rounded-lg">
                        <div class="text-white text-4xl mb-4">ðŸ’¼</div>
