...
<head>
    ...
    <style>
        ...
        .main-container {
            min-height: 100vh;
            background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('../photo/imgae.png');
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-6">
                        <a href="index(1).php" class="text-white hover:text-sky-300 transition-colors duration-300 text-xl">Home</a>
